...
class TimeSlotExtracter(SlotExtracter):
    ...
    def get_day(self, text):
        ...
        lp_1 = len(pattern_1.group(0)) if pattern_1 else None
        lp_2 = len(pattern_2.group(0)) if pattern_2 else None
        lp_3 = len(pattern_3.group(0)) if pattern_3 else None
        lp_4 = len(pattern_4.group(0)) if pattern_4 else None
        lp_5 = len(pattern_5.group(0)) if pattern_5 else None
        lp_6 = len(pattern_6.group(0)) if pattern_6 else None
...
if __name__ == "__main__":
    ...
    #     "我的生日马上到了", "再过一周就是我生日了",
    #     "生日是下个星期的星期一", '下礼拜星期二是我生日',
    #     '下个星期的星期二是我生日', '再过一周就是我生日了']
    text_list = [
    #  "下星期的星期二",
        "一九九八年1月18号",
    #   "我的生日还有一个月",
